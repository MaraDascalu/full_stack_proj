...
const connectDB = async () => {
  try {
    await mongoose.connect(
      `mongodb+srv://${MONGO_INITDB_ROOT_USERNAME}:${MONGO_INITDB_ROOT_PASSWORD}@cluster0.lzthrjh.mongodb.net/studentsdatabase`
    );
...
app.listen(
  EXPRESS_PORT,
  console.log(`Server is up and running on port ${EXPRESS_PORT}`)
);
