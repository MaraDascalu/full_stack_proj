...
const AccountList = ({ accounts }) => {
  const { deleteAccountAction } = useContext(accountContext);
          ...
          <div className="max-w-3xl mx-auto">
            {accounts?.length <= 0 ? (
              ...
              <>
                ...
                {accounts?.map((acc) => {
                  return (
                    <a className="group block mb-6" key={acc?._id}>
                        ...
                        <div>
                          ...
                          <button
                            onClick={() => {
                              ...
                              if (deleteAcc) {
                                deleteAccountAction(acc?._id);
                              }
                            }}
                            className="m-5 text-white bg-red-600 rounded-md border border-transparent px-4 py-2"
                          >
                            Delete
                          </button>
                        </div>
